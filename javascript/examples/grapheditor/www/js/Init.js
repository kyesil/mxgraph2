...
window.EXPORT_URL = window.EXPORT_URL || '_action.php?export';
window.SAVE_URL = window.SAVE_URL || '_action.php?save';
window.OPEN_URL = window.OPEN_URL || '_action.php?open';
